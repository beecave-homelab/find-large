...
This script performs:
  • pdm run fix
  • pdm run format
  • pdm run mdformat --number --compact-tables . --check --exclude '.venv/**' --exclude '.pytest_cache/**'
  • pdm run test
  • pdm run test-cov
"
}
...
main_logic() {
  ...
  echo "    • pdm run fix"
  echo "    • pdm run format"
  echo "    • pdm run mdformat --number --compact-tables . --check --exclude '.venv/**' --exclude '.pytest_cache/**'"
  echo "    • pdm run test"
